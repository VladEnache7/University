...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=False):  # pylint: disable=all
    ...
    @torch.no_grad()
    def loss_cardinality(self, outputs, targets, indices, num_boxes):  # pylint: disable=all
